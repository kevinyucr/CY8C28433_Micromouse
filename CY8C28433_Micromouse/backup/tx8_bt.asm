...
;  Global Symbols
;-----------------------------------------------
export   TX8_BT_SetTxIntMode
export  _TX8_BT_SetTxIntMode
export   TX8_BT_EnableInt
export  _TX8_BT_EnableInt
export   TX8_BT_DisableInt
export  _TX8_BT_DisableInt
export   TX8_BT_Start
export  _TX8_BT_Start
export   TX8_BT_Stop
export  _TX8_BT_Stop
export   TX8_BT_SendData
export  _TX8_BT_SendData
export   TX8_BT_bReadTxStatus
export  _TX8_BT_bReadTxStatus

// Old labels, will be removed in future release
// Do Not Use.
export   bTX8_BT_ReadTxStatus
export  _bTX8_BT_ReadTxStatus

;-----------------------------------------------
;  High Level TX functions
;-----------------------------------------------
export  TX8_BT_PutSHexByte
export _TX8_BT_PutSHexByte
export  TX8_BT_PutSHexInt
export _TX8_BT_PutSHexInt

export  TX8_BT_CPutString
export _TX8_BT_CPutString
export  TX8_BT_PutString
export _TX8_BT_PutString
export  TX8_BT_PutChar
export _TX8_BT_PutChar
export  TX8_BT_Write
export _TX8_BT_Write
export  TX8_BT_CWrite
export _TX8_BT_CWrite
export  TX8_BT_PutCRLF
export _TX8_BT_PutCRLF 
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX8_BT_EnableInt
;
;  DESCRIPTION:
...
_TX8_BT_EnableInt:
   ...
   M8C_EnableIntMask  TX8_BT_INT_REG, TX8_BT_bINT_MASK
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX8_BT_DisableInt
;
;  DESCRIPTION:
...
_TX8_BT_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_DisableIntMask TX8_BT_INT_REG, TX8_BT_bINT_MASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX8_BT_SetTxIntMode(BYTE bTxIntMode)
;
;  DESCRIPTION:
...
;
 TX8_BT_SetTxIntMode:
_TX8_BT_SetTxIntMode:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_SetBank1
   and   A, TX8_BT_INT_MODE_TX_COMPLETE
   jz    .SetModeRegEmpty
   or    REG[TX8_BT_FUNC_REG], bfFUNCTION_REG_TX_INT_MODE_BIT
   M8C_SetBank0
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret

.SetModeRegEmpty:
   and   REG[TX8_BT_FUNC_REG], ~bfFUNCTION_REG_TX_INT_MODE_BIT
   M8C_SetBank0
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX8_BT_Start(BYTE bParity)
;
;  DESCRIPTION:
...
_TX8_BT_Stop:
   RAM_PROLOGUE RAM_USE_CLASS_1
   and   REG[TX8_BT_CONTROL_REG], ~bfCONTROL_REG_START_BIT
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
_TX8_BT_SendData:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov REG[TX8_BT_TX_BUFFER_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX8_BT_bReadTxStatus
;
;  DESCRIPTION:
...
;    functions.
;
 TX8_BT_bReadTxStatus:
_TX8_BT_bReadTxStatus:
 bTX8_BT_ReadTxStatus:
_bTX8_BT_ReadTxStatus:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A,  REG[TX8_BT_CONTROL_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX8_BT_PutSHexByte
;
;  DESCRIPTION:
...
_TX8_BT_PutSHexByte:
    ...
    index TX8_BT_HEX_STR               ; Get Hex value
    call  TX8_BT_PutChar               ; Write data to screen
    pop   A                            ; Restore value
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX8_BT_PutSHexInt
;
;  DESCRIPTION:
...
_TX8_BT_PutSHexInt:
    RAM_PROLOGUE RAM_USE_CLASS_1
    swap  A,X
    call  TX8_BT_PutSHexByte           ; Print MSB
    mov   A,X                          ; Move LSB into position
    call  TX8_BT_PutSHexByte           ; Print LSB
    RAM_EPILOGUE RAM_USE_CLASS_1
    ret
.ENDSECTION
...
.BufEmptyWaitLoop:
   tst REG[TX8_BT_CONTROL_REG], TX8_BT_TX_BUFFER_EMPTY    ; Check Tx Status
   jz  .BufEmptyWaitLoop
   mov REG[TX8_BT_TX_BUFFER_REG], @Source    ; Write data to Tx Port
   endm
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX8_BT_PutString
;
;  DESCRIPTION:
...
.PutStringLoop:
   ...
   call  TX8_BT_PutChar                     ; Send character to Tx port
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX8_BT_CPutString
;
;  DESCRIPTION:
;     Send String out through UART TX port.
;
...
_TX8_BT_CPutString:
   ...
   romx                                          ; Get character from ROM
   jz    .End_CPutString
   call  TX8_BT_PutChar                     ; Print character
   pop   X
   pop   A
   inc   X                                       ; Inc LSB of pointer
   jnc   TX8_BT_CPutString                       ; Check for carry
   inc   A                                       ; Inc MSB of pointer
   jmp   TX8_BT_CPutString
